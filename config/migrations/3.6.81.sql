...
VALUES
    ('external_partner_outbox_claim_timeout_seconds', '300'),
    ('external_integration_retry_allow_query_token', '1'),
    ('external_integration_retry_header_name', 'X-SenNoKuni-Cron-Token')
