...
ON DUPLICATE KEY UPDATE display_name=VALUES(display_name), symbol=VALUES(symbol), status=VALUES(status);
...
ON DUPLICATE KEY UPDATE point_currency_code=VALUES(point_currency_code), name=VALUES(name);
...
INSERT IGNORE INTO schema_migrations (version, description) VALUES ('3.6.167', '千ノ国インフルエンサー向け4種LPテンプレート追加');
INSERT IGNORE INTO schema_migrations (version, description) VALUES ('3.6.168', '非公開LPテンプレート利用者の公開中テンプレート自動切替');
INSERT IGNORE INTO schema_migrations (version, description) VALUES ('3.6.169', 'ORLYポイント紹介付与基盤');
INSERT IGNORE INTO schema_migrations (version, description) VALUES ('3.6.170', 'ORLY説明会参加ポイント付与候補');
