...
$sharedFiles = [
    ...
    __DIR__ . '/../src/LandingPage/LandingPageRenderer.php',
    ...
    __DIR__ . '/../src/Notification/EmailNotificationChannel.php',
    __DIR__ . '/../src/Notification/LineNotificationChannel.php',
    __DIR__ . '/../src/Notification/ChatworkNotificationChannel.php',
    __DIR__ . '/../src/Notification/SlackNotificationChannel.php',
    __DIR__ . '/../src/Notification/LeadNotifier.php',
    ...
    __DIR__ . '/../src/Audit/LoginLogCsvExportService.php',
];
