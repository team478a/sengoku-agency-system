...
$sharedFiles = [
    ...
    __DIR__ . '/../src/Point/OrlyReferralPointAwardPlanner.php',
    __DIR__ . '/../src/Point/OrlyReferralPointCampaignRepository.php',
    __DIR__ . '/../src/Point/PointAwardEventRepository.php',
    __DIR__ . '/../src/Point/OrlyReferralPointAwardService.php',
    __DIR__ . '/../src/Point/OrlySeminarAttendancePointAwardService.php',
