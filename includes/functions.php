...
function getCommonIdFeatureFlags(): array {
    return [
        ...
        'orly_point_campaign_enabled' => getSystemSettingValue('orly_point_campaign_enabled', '0') === '1',
        'orly_point_award_enabled' => getSystemSettingValue('orly_point_award_enabled', '0') === '1',
        'orly_seminar_point_award_enabled' => getSystemSettingValue('orly_seminar_point_award_enabled', '0') === '1',
        'orly_wallet_delivery_enabled' => getSystemSettingValue('orly_wallet_delivery_enabled', '0') === '1',
